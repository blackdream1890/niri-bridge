...
Depends: libc6 (>= {metadata['minimum_glibc_symbol_version']}), libgcc-s1, libei1 (>= 1.0), python3 (>= 3.11), python3-gi, python3-gi-cairo, gir1.2-gtk-3.0, openssl, acl, pkexec, systemd, util-linux
